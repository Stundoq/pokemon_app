...
class BerryRepositoryImpl implements BerryRepository {
  ...
  @override
  Future<BerryDetailEntity> getBerryByName(String name) async {
    BerryDetailModel berryDetailModel = await remoteDataSourceImp.getBerryByName(name);
    return berryDetailModel.convertToEntity();
  }
}
